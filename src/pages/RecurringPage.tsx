...
import { Repeat, Plus, CheckCircle2, Play, Pause, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">Recurring Automation Engine</h2>
          <p className="text-xs text-slate-500">Automate recurring salaries, rent cheques, utilities, and subscriptions. Finalize to post directly to Income/Expenses.</p>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                <button
                  onClick={() => updateRecurringStatus(rec.RecurringID, rec.Status === 'Active' ? 'Paused' : 'Active')}
                ...
                <button
                  onClick={() => finalizeRecurringTransaction(rec.RecurringID)}
                  ...
                  title="Post this due recurring transaction now into Income/Expenses"
                >
                ...
                <button
                  onClick={() => deleteRecurringTransaction(rec.RecurringID)}
