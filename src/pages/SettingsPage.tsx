    ...
    <div className="space-y-6 pb-12">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded-full bg-teal-100 text-teal-800 dark:bg-teal-950 text-[10px] font-bold uppercase">
                        {u.RoleID === 'ROLE-ADMIN' ? 'Admin / Owner' : 'Partner'}
                      </span>
                      <span className="text-[10px] text-slate-400 font-mono">{u.Status}</span>
                    </div>
                  </div>
                </div>
      ...
      {activeTab === 'currencies' && (
        <div className="space-y-4 max-w-3xl">
          <div className="flex justify-between items-center">
            <h3 className="font-bold text-slate-900 dark:text-white text-base">Multi-Currency & Live Rates</h3>
            <button
              onClick={() => setIsCurrencyModalOpen(true)}
              className="flex items-center gap-1.5 px-3.5 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-xs font-bold shadow-sm"
            >
              <DollarSign className="w-4 h-4" /> Manage Exchange Rates
            </button>
          </div>
