        ...
        <div className="relative" ref={profileRef}>
          ...
          {profileOpen && (
            ...
            >
              ...
              <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800">
                ...
                {users.map((u) => (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-2 py-1.5 rounded-lg mb-1 transition-colors ${
              ...
              <div className="py-1">
                <button
                  onClick={() => addToast('info', 'Profile Settings', 'Navigate to Settings tab to edit profile preferences.')}
